...
public class Escritura {
	...
	public Escritura(int arch) throws IOException {
		if (arch==1) {
			this.f=new File("ArgentinoHuffman.Huf");
			this.f2=new File("ArgentinoHuffman.txt");
		}
		else if(arch==2) {
			this.f=new File("ChinoHuffman.Huf");
			this.f2=new File("ChinoHuffman.txt");
		}
		else {
			this.f=new File("ImagenHuffman.Huf");
			this.f2=new File("ImagenHuffman.txt");
		}
