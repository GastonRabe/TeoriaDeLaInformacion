...
public class Huffman {
	...
	public void getHuffman(NodoArbol arbol,String binario,Escritura escribir) {
		String auxBinario="";
		if(arbol!=null) {
			...
			this.getHuffman(arbol.getIzq(),"0",escribir);
			if(arbol.getSimbolo().length()==1) {
			System.out.println("Simbolo: "+arbol.getSimbolo()+" Código Huffman: "+arbol.getCodigoBinario());
			escribir.agregaResultado("Simbolo: "+arbol.getSimbolo()+" Código Huffman: "+arbol.getCodigoBinario());
			this.agregaLongitud(arbol);
			}
			this.getHuffman(arbol.getDer(), "1",escribir);
		}
