...
void procesoPalabras(int nroDigitos,Tlista *l){
    ...
    *l=NULL;
    ...
    if(kraft<=1.0)
        printf("Cumple con la inecuacion de Kraft/McMillan: %2.1f\n",kraft);
    else
        printf("No cumple con la inecuacion de Kraft/McMillan: %2.1f >= 1\n",kraft);
